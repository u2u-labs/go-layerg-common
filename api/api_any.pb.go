...
var file_api_any_proto_rawDesc = []byte{
	...
	0x0a, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x22, 0x20, 0x0a, 0x08, 0x41,
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x65,
	...
	0x78, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6c, 0x61, 0x79, 0x65, 0x72,
	0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x6e, 0x79, 0x51, 0x75, 0x65, 0x72,
	...
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x67, 0x2e,
	...
	0x3a, 0x02, 0x38, 0x01, 0x42, 0x06, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x42, 0x61, 0x0a, 0x16,
...
var file_api_any_proto_goTypes = []any{
	(*AnyQuery)(nil),          // 0: layerg.api.AnyQuery
	(*AnyRequest)(nil),        // 1: layerg.api.AnyRequest
	(*AnyResponseWriter)(nil), // 2: layerg.api.AnyResponseWriter
	nil,                       // 3: layerg.api.AnyRequest.HeaderEntry
	nil,                       // 4: layerg.api.AnyRequest.QueryEntry
	nil,                       // 5: layerg.api.AnyRequest.ContextEntry
	nil,                       // 6: layerg.api.AnyResponseWriter.HeaderEntry
}
var file_api_any_proto_depIdxs = []int32{
	3, // 0: layerg.api.AnyRequest.header:type_name -> layerg.api.AnyRequest.HeaderEntry
	4, // 1: layerg.api.AnyRequest.query:type_name -> layerg.api.AnyRequest.QueryEntry
	5, // 2: layerg.api.AnyRequest.context:type_name -> layerg.api.AnyRequest.ContextEntry
	6, // 3: layerg.api.AnyResponseWriter.header:type_name -> layerg.api.AnyResponseWriter.HeaderEntry
	0, // 4: layerg.api.AnyRequest.QueryEntry.value:type_name -> layerg.api.AnyQuery
...
func file_api_any_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_any_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_any_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_any_proto_msgTypes[2].Exporter = func(v any, i int) any {
