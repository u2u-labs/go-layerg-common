...
type Initializer interface {
	...
	*/
	...
	// RegisterBeforeAuthenticateUA can be used to perform pre-authentication checks.
	RegisterBeforeAuthenticateUA(fn func(ctx context.Context, logger Logger, db *sql.DB, layerg LayerGModule, in *api.UASocialLoginRequest) (*api.UASocialLoginRequest, error)) error

	// RegisterAfterAuthenticateUA can be used to perform after successful authentication checks.
	RegisterAfterAuthenticateUA(fn func(ctx context.Context, logger Logger, db *sql.DB, layerg LayerGModule, out *api.Session, in *api.UASocialLoginRequest) error) error
