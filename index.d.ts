declare namespace lgruntime {
    ...
    export interface RpcFunction {
         ...
         * @param lg - The LayerG server APIs.
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, payload: string): string | void;
    }
    ...
    export interface BeforeHookFunction<T> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, data: T): T | void;
    }
    ...
    export interface AfterHookFunction<T, K> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, data: T, request: K): void;
    }
    ...
    export interface RtBeforeHookFunction<T extends Envelope> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, envelope: T): T | void;
    }
    ...
    export interface RtAfterHookFunction<T extends Envelope> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, output: T | null, input: T): void;
    }
    ...
    export interface MatchmakerMatchedFunction {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, matches: MatchmakerResult[]): string | void;
    }
    ...
    export interface TournamentEndFunction {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, tournament: Tournament, end: number, reset: number): void;
    }
    ...
    export interface LeaderboardResetFunction {
         ...
         * @param reset - Reset time unix timestamp.
         */
        (ctx: Context, logger: Logger, lg: LayerG, leaderboard: Leaderboard, reset: number): void;
    }
    ...
    export interface ShutdownFunction {
         ...
         * @param lg - The LayerG server APIs.
         */
        (ctx: Context, logger: Logger, lg: LayerG): void;
    }
    ...
    export interface PurchaseNotificationAppleFunction {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, purchase: ValidatedPurchase, providerPayload: string): void;
    }
     ...
     */
       export interface SubscriptionNotificationAppleFunction {
         ...
         * @param providerPayload - The raw payload of the provider notificaton.
         */
        (ctx: Context, logger: Logger, lg: LayerG, subscription: ValidatedSubscription, providerPayload: string): void;
    }
    ...
    export interface StorageIndexFilterFunction {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, write: StorageWriteRequest): boolean;
    }
    ...
    export interface MatchInitFunction<State = MatchState> {
         ...
         * @param logger - The server logger.
         * @param lg - The LayerG server APIs.
         * @param params - Parameters that were passed to lg.matchCreate, if any.
         * @returns An object with the match state, tick rate and labels.
         */
        (ctx: Context, logger: Logger, lg: LayerG, params: {[key: string]: any}): {state: State, tickRate: number, label: string};
    }
    ...
    export interface MatchJoinAttemptFunction<State = MatchState> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, dispatcher: MatchDispatcher, tick: number, state: State, presence: Presence, metadata: {[key: string]: any}): {state: State, accept: boolean, rejectMessage?: string} | null;
    }
    ...
    export interface MatchJoinFunction<State = MatchState> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, dispatcher: MatchDispatcher, tick: number, state: State, presences: Presence[]): {state: State} | null;
    }
    ...
    export interface MatchLoopFunction<State = MatchState> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, dispatcher: MatchDispatcher, tick: number, state: State, messages: MatchMessage[]): {state: State} | null;
    }
    ...
    export interface MatchTerminateFunction<State = MatchState> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, dispatcher: MatchDispatcher, tick: number, state: State, graceSeconds: number): {state: State} | null;
    }
    ...
    export interface MatchSignalFunction<State = MatchState> {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, dispatcher: MatchDispatcher, tick: number, state: State, data: string): {state: State, data?: string} | null;
    }
    ...
    export interface LayerG {
        ...
        /**
         * Execute an SQL query to the LayerG database.
         *
        ...
        /**
         * Get the results of an SQL query to the LayerG database.
         *
         * @param sqlQuery - SQL Query string.
    ...
    /**
     * The start function for LayerG to initialize the server logic.
     */
    export interface InitModule {
         ...
         */
        (ctx: Context, logger: Logger, lg: LayerG, initializer: Initializer): void;
    }
